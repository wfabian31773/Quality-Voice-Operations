...
- **Not covered** by that test: `/workforce/teams/:id`, `/workforce/teams/:id/members`, `/scheduling/recurring`, `/dispatch/jobs/batch`, `/marketplace/installations/:id/customize`, `/autopilot/recommendations/:id/*`, `/digital-twin/*`, `/evolution/*`, `/gin/recommendations/:id/status`, `/insights/*`, `/improvements/suggestions/:id`, `/case-studies/:id`, `/widget/tokens/:id`, `/knowledge-documents/:id` (download), `/tool-executions/:id` (replay).
