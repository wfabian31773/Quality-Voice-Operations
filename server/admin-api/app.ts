...
import publicGinRoutes from './routes/publicGin';
...
import platformBillingReconciliationRoutes from './routes/platformBillingReconciliation';
...
app.use('/', platformBillingReconciliationRoutes);
