...
- **Federal DNC Registry Sync:** Implements weekly synchronization with the FTC National Do-Not-Call Registry to block calls to registered numbers, integrating with campaign pre-flight checks and audit logs.
