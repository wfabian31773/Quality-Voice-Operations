 ...
 * sibling marketing analytics helpers and stays silent on imported
 * constants and genuinely dynamic expressions.
 */
'use strict';
...
ruleTester.run('no-literal-analytics-label', rule, {
  valid: [
    // Canonical pattern: imported constant for each helper.
