...
const EN: Record<AgentBuilderTKey, string> = {
  ...
  voicePreviewNeedsGreeting: 'Add a welcome greeting first to preview voices.',
...
const ES: Partial<Record<AgentBuilderTKey, string>> = {
  ...
  voicePreviewNeedsGreeting: 'Añade un saludo de bienvenida para escuchar las voces.',
...
const FR: Partial<Record<AgentBuilderTKey, string>> = {
  ...
  voicePreviewNeedsGreeting: 'Ajoutez un message d\'accueil pour écouter les voix.',
...
const DE: Partial<Record<AgentBuilderTKey, string>> = {
  ...
  voicePreviewNeedsGreeting: 'Fügen Sie zuerst eine Begrüßung hinzu, um Stimmen zu hören.',
...
const PT: Partial<Record<AgentBuilderTKey, string>> = {
  ...
  voicePreviewNeedsGreeting: 'Adicione uma saudação para ouvir as vozes.',
  voicePreviewRecommendedBadge: 'Recomendada',
...
const IT: Partial<Record<AgentBuilderTKey, string>> = {
  ...
  voicePreviewNeedsGreeting: 'Aggiungi un saluto di benvenuto per ascoltare le voci.',
...
const NL: Partial<Record<AgentBuilderTKey, string>> = {
  ...
  voicePreviewNeedsGreeting: 'Voeg eerst een welkomstgroet toe om stemmen te beluisteren.',
...
const ZH: Partial<Record<AgentBuilderTKey, string>> = {
  ...
  voicePreviewNeedsGreeting: '请先填写欢迎语,然后再试听语音。',
...
const JA: Partial<Record<AgentBuilderTKey, string>> = {
  ...
  voicePreviewNeedsGreeting: '音声を試聴するには、先に挨拶文を入力してください。',
...
const KO: Partial<Record<AgentBuilderTKey, string>> = {
  ...
  voicePreviewNeedsGreeting: '음성을 미리 들으려면 먼저 환영 인사말을 입력하세요.',
...
const AR: Partial<Record<AgentBuilderTKey, string>> = {
  ...
  voicePreviewNeedsGreeting: 'أضف رسالة ترحيب أولاً للاستماع إلى الأصوات.',
...
const HI: Partial<Record<AgentBuilderTKey, string>> = {
  ...
  voicePreviewNeedsGreeting: 'आवाज़ें सुनने के लिए पहले स्वागत संदेश जोड़ें।',
