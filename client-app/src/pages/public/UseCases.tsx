...
export default function UseCases() {
  ...
  return (
    <div>
      ...
      />
      {/*
        UseCases hero — flat dark band placeholder. Wayne's bespoke
        Higgsfield render slots in here later (drop file at
        /hero/use-cases-hero.{webp,mp4} and add a <picture>/<video> above
        the gradient layer). Until then:
          - radial-gradient backdrop, off-center at 60% 40% so it doesn't
            feel identical to Pricing (50% 30%) or Features (30% 50%)
