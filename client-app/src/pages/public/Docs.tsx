...
export default function Docs() {
  ...
  return (
    <div>
      ...
      {/*
        Docs hero — flat dark band placeholder. Wayne's bespoke
        Higgsfield render slots in here later (drop file at
        /hero/docs-hero.{webp,mp4} and add a <picture>/<video> above
        the gradient layer). Until then:
          - radial-gradient backdrop at 45% 55% (off-center; docs hero
            has a search bar below the copy so the glow stays centered
            on the content stack)
        ...
        Padding stayed py-16 lg:py-20 — search-bar hero needs less air.
      */}
      <section className="relative overflow-hidden bg-sidebar-bg text-white py-16 lg:py-20">
        <div
          ...
          style={{
            background:
              'radial-gradient(ellipse 70% 60% at 45% 55%, rgba(46,140,131,0.20), transparent 70%)',
          }}
        />
        <div className="relative max-w-7xl mx-auto px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <h1 className="font-display text-white text-3xl lg:text-6xl font-bold leading-tight tracking-tight mb-4">
                        ...
                        {articles.map((a) => {
                          ...
                          return (
                            <Link
                              key={a.slug}
                              to={`/docs/${a.slug}`}
                              className="group bg-surface rounded-xl border border-border/50 p-4 hover:border-primary/40 hover:shadow-sm transition-all"
                            >
      ...
      <section className="bg-sidebar-bg text-white py-12">
        <div className="max-w-3xl mx-auto px-6 lg:px-8 text-center">
          {/* Explicit text-white + tracking-tight defensive against the
              ...
              above. */}
          <h2 className="font-display text-white text-xl lg:text-2xl font-bold tracking-tight mb-3">Still need help?</h2>
