  ...
  return (
    ...
    {zoomed && zoomedIndex !== null && (
      <Modal
        ...
        containerClassName="fixed inset-0 z-palette flex items-center justify-center p-4 sm:p-8 cursor-zoom-out"
      ...
      >
        ...
        <button
          ...
          className="absolute top-4 right-4 text-white/80 hover:text-white bg-white/10 dark:bg-white/10 hover:bg-white/20 dark:hover:bg-white/20 rounded-full p-2 transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-white z-sticky-header"
        >
          <X className="h-5 w-5" />
        </button>
        {hasMultiple && (
          <>
            <button
              ...
              className="absolute left-2 sm:left-4 top-1/2 -translate-y-1/2 text-white/80 hover:text-white bg-white/10 dark:bg-white/10 hover:bg-white/20 dark:hover:bg-white/20 rounded-full p-2 sm:p-3 transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-white z-sticky-header"
            >
            ...
            <button
              ...
              className="absolute right-2 sm:right-4 top-1/2 -translate-y-1/2 text-white/80 hover:text-white bg-white/10 dark:bg-white/10 hover:bg-white/20 dark:hover:bg-white/20 rounded-full p-2 sm:p-3 transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-white z-sticky-header"
            >
              <ChevronRight className="h-5 w-5 sm:h-6 sm:w-6" />
            </button>
            <div className="absolute top-4 left-1/2 -translate-x-1/2 text-xs sm:text-sm text-white/80 bg-white/10 dark:bg-white/10 rounded-full px-3 py-1 font-body tabular-nums z-sticky-header">
