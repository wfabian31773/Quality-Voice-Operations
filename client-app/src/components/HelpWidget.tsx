  ...
  return (
    <>
      <button
        ...
        className="fixed z-drawer bottom-24 right-6 h-12 w-12 rounded-full bg-primary hover:bg-primary-hover text-white shadow-lg flex items-center justify-center transition-transform hover:scale-105"
      >
      ...
      {open && (
        <div
          ref={ref}
          className="fixed z-drawer bottom-40 right-6 w-[360px] max-w-[calc(100vw-2rem)] bg-surface border border-border rounded-xl shadow-2xl overflow-hidden flex flex-col max-h-[70vh]"
        >
